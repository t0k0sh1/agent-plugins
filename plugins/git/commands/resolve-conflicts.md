...
description: Resolve PR conflicts locally and push
---
...
Resolve merge conflicts for a PR by merging the base branch locally, fixing conflicts, and pushing. User input: $ARGUMENTS
